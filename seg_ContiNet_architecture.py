# Code for ContiNet architecture for segmentation
...
class ContiNetBackbone(nn.Module):
    def __init__(self, num_points=2500, num_global_feats=1024, local_feat=True):
        ...
        self.conv4 = nn.Conv1d(207, 600, kernel_size=1)
...
class ContiNetSegmentation(nn.Module):
    def __init__(self, num_points=4096, num_global_feats=1024, m=14):
        ...
        self.conv9 = nn.Conv1d(539, 412, kernel_size=1)
    ...
    def forward(self, x):
        ...
        x = torch.cat((x, feature_1), dim=1)         # (nx539)
        x = self.dropout1(x)
...
# ============================================================================
# This code for testing of the above architecture for any shape and size error 
def main():
